...
let print_binop fmt = function
  ...
  | Ml_mul -> Format.pp_print_string fmt "*"
  | Ml_eq -> Format.pp_print_string fmt "="
  | Ml_inf -> Format.pp_print_string fmt "<"
...
let print_def def =
    let fmt = Format.std_formatter in
    match def with
    | Ml_def_let(id, expr) -> Format.pp_print_string fmt ("(IDENT) -> " ^ id ^ " "); print_expr expr
    | Ml_def_rec(id, expr) -> Format.pp_print_string fmt ("(REC) -> " ^ id ^ " "); print_expr expr

let print_ast ast = match ast with
| Ml_expr e -> print_expr e
| Ml_def d -> print_def d
